d3 = function() {
  ...
  d3.layout.histogram = function() {
    ...
    histogram.bins = function(x) {
      ...
      binner = typeof x === "SVG_HEIGHT" ? function(range) {
  ...
  d3.layout.treemap = function() {
    ...
    treemap.padding = function(x) {
      ...
      function padFunction(node) {
        ...
        return p == null ? d3_layout_treemapPadNull(node) : d3_layout_treemapPad(node, typeof p === "SVG_HEIGHT" ? [ p, p, p, p ] : p);
      }
      function padConstant(node) {
        return d3_layout_treemapPad(node, x);
      }
      var type;
      pad = (padding = x) == null ? d3_layout_treemapPadNull : (type = typeof x) === "function" ? padFunction : type === "SVG_HEIGHT" ? (x = [ x, x, x, x ],
  ...
  function d3_time_scale(linear, methods, format) {
    ...
    scale.nice = function(interval, skip) {
      var domain = scale.domain(), extent = d3_scaleExtent(domain), method = interval == null ? tickMethod(extent, 10) : typeof interval === "SVG_HEIGHT" && tickMethod(extent, interval);
    ...
    scale.ticks = function(interval, skip) {
      var extent = d3_scaleExtent(scale.domain()), method = interval == null ? tickMethod(extent, 10) : typeof interval === "SVG_HEIGHT" ? tickMethod(extent, interval) : !interval.range && [ {
        range: interval
      }, skip ];
      if (method) interval = method[0], skip = method[1];
